...
function convertToASCII(sting){
    ...
    for(i = 0; i < sting.length; i++){
        tab.push(hexStringToByteArray(sting.slice(min,max)));
        min+=2;
        max+=2;
    }
    return tab
...
let C2 = '3F4F3250224C2E53274D35543C453A413D492F492D4E214420432A502045264521542F45304E27473E413C4F32503D4C3E532D4D28543B4528413A492749244E3D4436432A5020453B4527542345314E2C473F41214F39502B4C20532D4D36542D45244120492649364E364429433D';

const result = convertToASCII(C2);
console.log(result);