ffunction convertToASCII(string){
...
const result = ascii_to_string(xor(convertToASCII(C0),convertToASCII(C2)));
const result2 = ascii_to_string(xor(convertToASCII(C1),convertToASCII(C2)));
const result3 = ascii_to_string(xor(convertToASCII(C1),convertToASCII(C0)));
